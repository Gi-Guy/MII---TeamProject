...
document.addEventListener("DOMContentLoaded", () => {
    ...
    function openChangeReservationModal(reservationId) {
       ...
       `;
        ...
        modal.querySelector("#save-changes")?.addEventListener("click", () => {
            const updatedReservation = {
                ...
                userEmail: modal.querySelector("#useremail").value,
                date: modal.querySelector("#date").value,
                time: modal.querySelector("#time").value,
                guests: parseInt(modal.querySelector("#guests").value, 10),
                seating: modal.querySelector("#seating").value,
                table: parseInt(modal.querySelector("#table").value, 10),
            };
